<template>
  <div class="app-container">
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
        ...
        <el-button  style="color:red" type="text" size="medium" @click="handleDelete(scope.$index,scope.row)" >紧急</el-button>
      </template>
    </el-table-column>
  </el-table>
  ...
  <span slot="footer" class="dialog-footer">
    <el-button type="primary" @click="judgeReportConfirm" :disabled='action'>确 定</el-button>
    <el-button type="danger" @click="judgeReportDeny" :disabled='action'>驳回</el-button>
    <el-button type="warning" @click="expert" :disabled='action'>专家介入</el-button>
...
methods: {
  ...
  handleClick(index,row){
    ...
    if (this.tableData[index].status!='待审批'){
        this.action=true;
    }
    else{
    this.action=false;
